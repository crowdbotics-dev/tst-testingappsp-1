"""
Django settings for tst_testingappsp_1 project.
...
ROOT_URLCONF = 'tst_testingappsp_1.urls'
...
WSGI_APPLICATION = 'tst_testingappsp_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "tst-testingappsp Support <support@tst-testingappsp-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_testingappsp_1 API",
    "DESCRIPTION": "API documentation for tst_testingappsp_1 App",
    "VERSION": "v1",
}
